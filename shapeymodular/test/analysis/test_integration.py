...
class TestIntegration:
    def test_batch_processing_corrmat_obj_ax_subset(
        self, corrmat_no_contrast, nn_analysis_config
    ):
        ...
        for obj in objs:
            for ax in nn_analysis_config.axes:
                ...
                col_shapey_idx = corrmat_no_contrast[0].description[1].shapey_idxs
                ...
                corrmats_obj_ax_subset = [
                    ...
                    for corrmat in corrmat_no_contrast
                ]
                ...
                assert np.allclose(
                    corrmat_no_contrast[0].corrmat[row_corrmat_idx, :][
                        :, col_corrmat_idx
                    ],
